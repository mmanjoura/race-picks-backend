...
// 	err := updateWinners(db)
// 	if err != nil {
// 		return err
// 	}

// 	// check if we have already saved the horse information
// 	rows, err := db.Query(`SELECT selection_id, selection_name FROM EventRunners WHERE DATE(event_date) = DATE('now')`)
// 	if err != nil {
// 		return err
// 	}
// 	defer rows.Close()

// 	var horseInforamtions []models.TodayRunners
// 	if !rows.Next() {
...
// 			horseInforamtion.EventLink, // Include the event link
...
// 		err = saveSelectionsForm(db, horseInforamtion.SelectionID, horseInforamtion.SelectionLink, horseInforamtion.SelectionName)
// 		if err != nil {
// 			return err
// 		}
// 	}
...
// func updateWinners(db *sql.DB) error {
...
// 		err = saveSelectionsForm(db, selection.ID, selection.Link, selection.Name)
// 		if err != nil {
// 			return err
// 		}
// 	}
...
// func saveSelectionsForm(db *sql.DB, selectionID int, selectionLink, selectionName string) error {
...
// 			return err
// 		}
// 		err = saveSelectionForm(db, selectionsForm, selectionName, selectionID)
// 		if err != nil {
// 			return err
// 		}
...
// func saveSelectionForm(db *sql.DB, selectionsForm []models.SelectionsForm, selectionName string, selectionID int) error {
...
// 		raceClass := e.ChildText("td:nth-child(8)")
